...
<head>
    ...
    <!-- Theme color -->
    <link id="switcher" href="{{ asset('frontend/css/theme-color/green-theme.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('frontend/magiczoomplus/magiczoomplus.css') }}" rel="stylesheet">
          ...
          <div class="col-md-12">
            ...
            <!-- start header top left -->
              <div class="aa-header-top-left">
                ...
                <!-- start cellphone -->
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>0123-456-789</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="{!! URL('/') !!}">
                  ...
                  <p>Pharma <strong>LMAO</strong> <span>Good health</span></p>
                </a>
                <!-- img based logo -->
